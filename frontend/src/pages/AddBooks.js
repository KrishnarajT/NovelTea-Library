		...
		<div className="overflow-x-hidden">
			<div className="flex justify-center p-4 m-4 flex-col gap-4 items-center">
				...
				<div className="bg-pink-50 text-3xl rounded-3xl p-8 m-4 ">
					Welcome to the Book Addition Page of our library! We believe
					in the power of community and collective knowledge. By
					contributing your favorite books to our library, you're not
					only sharing stories but also enriching the literary
					tapestry for all our readers.
					<br></br>
					<br></br>
					By adding your book to our library, you become an integral
					part of our literary journey. Together, we build a
					collection that embodies the diverse tastes and passions of
					our community. Thank you for helping us create a tapestry of
					stories that enriches the lives of our readers.
				</div>
			</div>
