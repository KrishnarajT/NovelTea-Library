...
const Home = () => {
  ...
  const retrieve_books = async () => {
    const response = await axios
      .get(apiUrl + "/get_books.php")
      .then((response) => {
        console.log(response.data);
        return response.data;
      })
      .catch(async (error) => {
      	console.log("there was some error while requesting node server, trying with php")
        console.log(error);
         // const response = await axios
			      // .get(apiUrl + "/get_books.php")
			      // .then((response) => {
			      ...
			      // .catch((error) => {
			        // console.log(error);
			        // alert("some error occured in the php server as well as the node server. Couldnt reach. ");
			        // return false;
			      // });
